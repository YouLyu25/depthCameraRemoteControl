...
# global variables
TEST = True
mqttServer = "mqtt.dev.meetwhale.com"
mqttPort = 1883
mqttUsername = "whale_smart"
mqttPassword = "Buzhongyao"
grpcChannel = "106.15.189.129:3022"
client = mqtt.Client()
heartBeatTopic = "remoteControl/heartBeat"
topicPrefix = "remoteControl/"
mainBGDataReady = {}
subBGDataReady = {}
FGDataReady = {}
FGURL = {}
...
def trainSubBGModel(request):
    if request.POST.get("op") == "train sub background model":
        topic = "remoteControl/" + request.POST.get("deviceMAC")[1:]
